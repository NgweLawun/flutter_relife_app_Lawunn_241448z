...
class ProfilePage extends StatelessWidget {
  ...
  Future<void> saveProfile(BuildContext context) async {
    ...
    try {
      ...
      // NEW: persist to Firestore, keyed by this user's UID
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('Hello  ${usernameController.text}'), // CHANGED: reads from controller now populated from Firestore
                      const SizedBox(height: 20),
                      TextField(
                      ...
                      TextField(
                        ...
                        enabled: false, // NEW: email is tied to the Firebase account, shouldn't be freely edited here
                        decoration: InputDecoration(
                          labelText: 'Email',
                          ...
                          return const Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                SizedBox(width: 5),
                                Text('Your Profile has been Updated!', style: TextStyle(color: Colors.green)),
                              ],
                            ),
                          );
                        },
